...
const translations = {
  tr: {
    ...
    'daily.subtitle': 'Beş yükselen bulmacayı çöz. İlk tamamlamada seri ve mücevher ödülü bir kez verilir.',
    ...
    'home.dailyCardA11y': 'Günlük meydan okuma, {{streak}} günlük seri',
  ...
  en: {
    ...
    'home.pointsA11y': '{{value}} points', 'home.gemsA11y': '{{value}} gems', 'home.playA11y': 'Level {{level}}, continue', 'home.playHint': 'Opens your current number puzzle', 'home.worldRoute': 'World route', 'home.routeProgress': '{{route}}, {{progress}}/{{total}} countries completed', 'home.countryDone': 'completed', 'home.currentCountry': 'current country', 'home.notUnlocked': 'not unlocked yet', 'home.discovered': '🌍 {{done}}/{{total}} countries discovered', 'home.dailyCardA11y': 'Daily challenge, {{streak}} day streak', 'home.dailyReady': 'Today’s challenge is ready', 'home.dailyDone': 'Completed · play again', 'home.dailyClaim': 'Claim your reward',
