...
const translations = {
  tr: {
    ...
    'daily.subtitle': 'Sekiz bulmacayı çöz: her işlemden iki. İstediğin kadar tekrar oynayabilirsin; her koşuda yeni sorular gelir ve bugünü bitirmiş olsan bile puanı ve kristalleri yeniden kazanırsın. Yalnız seri günde bir kez artar.',
    'daily.loading': 'Günlük meydan okuma hazırlanıyor…',
    'daily.backA11y': 'Günlük meydan okumadan geri dön',
    'daily.puzzleProgress': '{{completed}}/{{total}} bulmaca tamamlandı',
    'daily.goalSolvePuzzles': 'Tüm bulmacaları çöz',
    'daily.goalBonus': 'Tüm bonus hedefleri bul',
    'daily.goalBonusExtra': 'Ek paket +{{gems}} mücevher',
    'daily.goalNoHints': 'İpucusuz tamamla',
    'daily.streak': '🔥 {{count}} günlük seri',
    'daily.hudStreak': '🔥 {{count}}',
    'daily.hudOpLabel': 'İŞLEM',
    'daily.hudStreakLabel': 'SERİ',
    'daily.hudStepLabel': 'ADIM',
    'daily.start': 'MEYDAN OKUMAYA BAŞLA',
    'daily.continueRun': 'DEVAM ET',
    'daily.replay': 'TEKRAR OYNA',
    'daily.replayA11y': 'Yeni sorularla tekrar oyna',
    'daily.trainingBadge': 'Koşu tamamlandı',
    'daily.targetA11y': 'Hedef {{value}}, {{steps}} sayı',
    'daily.bonusA11y': 'Bonus hedef {{value}}, ödül {{reward}} mücevher',
    'daily.targetFound': 'Hedef bulundu! ✓ • +{{points}} puan',
    'daily.bonusFound': 'Bonus hedef! 💎 +{{reward}} • +{{points}} puan',
    'daily.nextPuzzle': 'SONRAKİ BULMACA',
    'daily.treasureTitle': 'HAZİNE HAZIR!',
    'daily.treasureSubtitle': 'Koşuyu tamamladın. Hazine paketi hazır.',
    'daily.reward': 'Hazine paketi: {{gems}} mücevher',
    'daily.claimReward': 'ÖDÜLÜ AL',
    'daily.completedTitle': 'GÜNLÜK MEYDAN OKUMA TAMAMLANDI',
    'daily.completedHaul': '+{{points}} puan · 💎 +{{gems}}',
    'daily.completedSummary': 'Sekiz bulmacayı çözdün. Tekrar oyna: yeni sorular, aynı ödüller.',
    'daily.alreadyCompleted': 'Bugünü bitirdin ve serin işlendi. İstediğin kadar tekrar oynayabilirsin; her koşuda yeni sorular gelir, puanı, bonus kristallerini ve hazine paketini yeniden kazanırsın.',
    'daily.replayRewards': 'Tekrar oyna: her koşuda yeni sorular ve tam ödül.',
    'daily.returnHome': 'ANASAYFAYA DÖN',
    'daily.hudTitle': 'GÜNLÜK MEYDAN OKUMA',
    'daily.puzzleHud': 'Bulmaca {{current}}/{{total}}',
    'daily.tierWarmup': 'Işınma',
    'daily.tierTempo': 'Tempo',
    'daily.tierPeak': 'Zirve',
    'daily.stepsLabel': '{{steps}} adım',
    'daily.transitionComplete': 'BULMACA TAMAMLANDI',
    'daily.transitionNext': 'SONRAKİ DURAK',
    'daily.transitionTreasure': 'HAZİNEYE GEÇ',
    'daily.transitionPeak': 'MİNİ MEYDAN OKUMA',
    'daily.briefingGoals': 'BUGÜNÜN HEDEFLERİ',
    'daily.railA11y': '{{completed}}/{{total}} bulmaca rayı',
    'daily.miniChallenge': 'Mini meydan okuma',
    ...
    'home.learningLevel': 'Ustalık {{level}}',
    'home.dailyCardLabel': 'Günlük Meydan Okuma · 🔥',
    'home.dailyCardA11y': 'Günlük meydan okuma',
    'home.dailyReady': 'Bugünün meydan okuması hazır',
    'home.dailyDone': 'Tamamlandı · tekrar oyna',
    'home.dailyClaim': 'Ödülünü al',
    ...
    'profile.learningLevel': 'Ustalık {{level}}',
    ...
    'profile.difficultyMeta': 'Son {{count}} puzzle değerlendirildi • Zorluk yeni şehirde ve şehir içinde rahatlamayla değişir',
    ...
    'tutorial.eyebrow': 'OYUN EĞİTİMİ · {{current}}/{{total}}', 'tutorial.bonusTitle': '💎 BONUS HEDEFİ BUL', 'tutorial.targetTitle': 'HEDEF SAYIYI BUL', 'tutorial.explanation': '{{operation}} işlemi • {{steps}} adım', 'tutorial.shuffleInstruction': 'Önce sayıları karıştır.', 'tutorial.hintInstruction': 'Şimdi ipucuna dokun; çözüm gösterilecek.', 'tutorial.demoInstruction': 'İpucu: sayıları sırayla bağlanır.', 'tutorial.practiceInstruction': 'Aynı soruyu şimdi sen çöz.', 'tutorial.connectInstruction': 'Doğru sayıları sırayla birleştir.', 'tutorial.practiceButton': 'ŞİMDİ SEN ÇÖZ', 'tutorial.shuffleButton': '↻ KARIŞTIR', 'tutorial.hintButton': '💡 İPUCU', 'tutorial.expression': '{{expression}} = {{target}}', 'tutorial.skip': 'ATLA', 'tutorial.skipA11y': 'Oyun eğitimini atla', 'tutorial.celebrateTitle': 'Hazırsın!', 'tutorial.celebrateSubtitle': 'Beş eğitimi de tamamladın.', 'tutorial.celebrateDone': 'Eğitim tamamlandı', 'tutorial.celebrateBody': 'Artık harikaları keşfetme zamanı!',
    'wheel.a11y': 'Sayı bağlantı çemberi',
    'wheel.hint': '💎 {{cost}}',
    'wheel.hintA11y': 'İpucu göster, ücret {{cost}} mücevher',
    'wheel.hintAd': '+{{reward}}',
    'wheel.hintAdA11y': 'Reklam izle, {{reward}} kristal kazan',
    'wheel.hintAdCta': 'Reklam izle, {{reward}} kristal kazan',
    'wheel.noHints': 'Yetersiz mücevher',
    ...
    'modal.viewMap': 'HARİTAYI GÖR',
    'modal.viewMapA11y': 'Seyahat haritasını aç',
    ...
    'feedback.noHints': 'Yetersiz mücevher • İpucu için {{cost}} mücevher gerekli',
    'feedback.hintAdPreparing': 'Reklam hazırlanıyor…',
    ...
    'feedback.masterStarted': '🌍 Master World Tour başladı!', 'feedback.countryUnlocked': '{{flag}} {{country}} açıldı • {{destination}}{{reward}}', 'feedback.routeGemReward': ' • Yeni rota ödülü: +{{count}} mücevher', 'feedback.routeGemToast': '💎 Yeni rota mührü • +{{count}} mücevher',
  },
  en: {
    ...
    'daily.title': 'DAILY CHALLENGE', 'daily.subtitle': 'Solve eight puzzles, two of each operation. Replay as often as you like: every run brings new questions and earns the points and gems all over, even if you already finished today. Only the streak is once a day.', 'daily.loading': 'Preparing today’s challenge…', 'daily.backA11y': 'Leave daily challenge', 'daily.puzzleProgress': '{{completed}}/{{total}} puzzles completed', 'daily.goalSolvePuzzles': 'Solve all puzzles', 'daily.goalBonus': 'Find all bonus targets', 'daily.goalBonusExtra': 'Extra pack +{{gems}} gems', 'daily.goalNoHints': 'Finish without hints', 'daily.streak': '🔥 {{count}} day streak', 'daily.hudStreak': '🔥 {{count}}', 'daily.hudOpLabel': 'OP', 'daily.hudStreakLabel': 'STREAK', 'daily.hudStepLabel': 'STEPS', 'daily.start': 'START THE CHALLENGE', 'daily.continueRun': 'CONTINUE', 'daily.replay': 'PLAY AGAIN', 'daily.replayA11y': 'Play again with new questions', 'daily.trainingBadge': 'Run complete', 'daily.targetA11y': 'Target {{value}}, {{steps}} numbers', 'daily.bonusA11y': 'Bonus target {{value}}, reward {{reward}} gems', 'daily.targetFound': 'Target found! ✓ • +{{points}} points', 'daily.bonusFound': 'Bonus target! 💎 +{{reward}} • +{{points}} points', 'daily.nextPuzzle': 'NEXT PUZZLE', 'daily.treasureTitle': 'TREASURE READY!', 'daily.treasureSubtitle': 'You finished the run. The treasure pack is ready.', 'daily.reward': 'Treasure pack: {{gems}} gems', 'daily.claimReward': 'CLAIM REWARD', 'daily.completedTitle': 'DAILY CHALLENGE COMPLETED', 'daily.completedHaul': '+{{points}} points · 💎 +{{gems}}', 'daily.completedSummary': 'You solved eight puzzles. Play again: new questions, the same rewards.', 'daily.alreadyCompleted': 'You finished today and your streak is locked in. Play as often as you like: every run brings new questions and earns the points, the bonus gems and the treasure pack all over.', 'daily.replayRewards': 'Play again: every run brings new questions and the full reward.', 'daily.returnHome': 'RETURN HOME', 'daily.hudTitle': 'DAILY CHALLENGE', 'daily.puzzleHud': 'Puzzle {{current}}/{{total}}', 'daily.tierWarmup': 'Warm-up', 'daily.tierTempo': 'Tempo', 'daily.tierPeak': 'Peak', 'daily.stepsLabel': '{{steps}} steps', 'daily.transitionComplete': 'PUZZLE COMPLETE', 'daily.transitionNext': 'NEXT STOP', 'daily.transitionTreasure': 'TREASURE AHEAD', 'daily.transitionPeak': 'MINI CHALLENGE', 'daily.briefingGoals': 'TODAY’S GOALS', 'daily.railA11y': '{{completed}}/{{total}} puzzle track', 'daily.miniChallenge': 'Mini challenge',
    ...
    'home.pointsA11y': '{{value}} points', 'home.gemsA11y': '{{value}} gems', 'home.playA11y': 'Level {{level}}, continue', 'home.playHint': 'Opens your current number puzzle', 'home.worldRoute': 'World route', 'home.routeProgress': '{{route}}, {{progress}}/{{total}} countries completed', 'home.countryDone': 'completed', 'home.currentCountry': 'current country', 'home.notUnlocked': 'not unlocked yet', 'home.discovered': '🌍 {{done}}/{{total}} countries discovered', 'home.learningLevel': 'Skill {{level}}', 'home.dailyCardLabel': 'Daily Challenge · 🔥', 'home.dailyCardA11y': 'Daily challenge', 'home.dailyReady': 'Today’s challenge is ready', 'home.dailyDone': 'Completed · play again', 'home.dailyClaim': 'Claim your reward',
    'profile.title': 'PROFILE', 'profile.explorer': 'World Explorer', 'profile.location': 'Level {{level}} • {{country}} • {{city}}', 'profile.difficultyEyebrow': 'GAME DIFFICULTY', 'profile.learningLevel': 'Skill {{level}}', 'profile.difficultyAdvanced': 'ADVANCED', 'profile.difficultySupported': 'SUPPORTED', 'profile.difficultyBalanced': 'BALANCED', 'profile.difficultyPending': 'Solve a few more puzzles to determine your ideal difficulty.', 'profile.difficultyHarder': 'Based on your recent performance, the number pool will be slightly larger in the next cities.', 'profile.difficultyEasier': 'Based on your recent performance, the number pool will be a little more accessible in the next cities.', 'profile.difficultySame': 'Your current difficulty is being maintained based on recent performance.', 'profile.difficultyMeta': '{{count}} recent puzzles evaluated • Difficulty changes in a new city and eases after repeated struggle', 'profile.completedPuzzles': 'PUZZLES COMPLETED', 'profile.country': 'COUNTRY', 'profile.gem': 'GEMS', 'profile.currentJourney': 'CURRENT JOURNEY', 'profile.worldTour': 'World tour: {{done}}/{{total}}', 'profile.playerLevel': 'Player level: {{level}}', 'profile.bonuses': '⭐ {{count}} bonus combinations discovered', 'profile.passport': 'Travel Passport', 'profile.passportStamps': '{{done}}/{{total}} country stamps', 'profile.openPassport': 'Open travel passport', 'profile.resume': '▶  CONTINUE LEVEL', 'profile.resumeA11y': 'Continue your current level',
    ...
    'feedback.masterStarted': '🌍 Master World Tour started!', 'feedback.countryUnlocked': '{{flag}} {{country}} unlocked • {{destination}}{{reward}}', 'feedback.routeGemReward': ' • New route reward: +{{count}} gems', 'feedback.routeGemToast': '💎 New route stamp • +{{count}} gems',
  },
  ru: {
    'language.tr': 'Türkçe', 'language.en': 'English', 'language.ru': 'Русский',
    ...
    'daily.title': 'ЕЖЕДНЕВНОЕ ИСПЫТАНИЕ', 'daily.subtitle': 'Решите восемь головоломок — по две на каждую операцию. Повторять можно сколько угодно: каждый заход даёт новые задания и снова приносит очки и алмазы, даже если сегодняшнее испытание уже пройдено. Только серия растёт один раз в день.', 'daily.loading': 'Готовим ежедневное испытание…', 'daily.backA11y': 'Выйти из ежедневного испытания', 'daily.puzzleProgress': 'Пройдено головоломок: {{completed}}/{{total}}', 'daily.goalSolvePuzzles': 'Решите все головоломки', 'daily.goalBonus': 'Найдите все бонусные цели', 'daily.goalBonusExtra': 'Доп. пакет +{{gems}} алмазов', 'daily.goalNoHints': 'Пройдите без подсказок', 'daily.streak': '🔥 Серия: {{count}} дн.', 'daily.hudStreak': '🔥 {{count}}', 'daily.hudOpLabel': 'ОПЕР.', 'daily.hudStreakLabel': 'СЕРИЯ', 'daily.hudStepLabel': 'ШАГИ', 'daily.start': 'НАЧАТЬ ИСПЫТАНИЕ', 'daily.continueRun': 'ПРОДОЛЖИТЬ', 'daily.replay': 'ИГРАТЬ СНОВА', 'daily.replayA11y': 'Играть снова с новыми заданиями', 'daily.trainingBadge': 'Заход завершён', 'daily.targetA11y': 'Цель {{value}}, чисел: {{steps}}', 'daily.bonusA11y': 'Бонусная цель {{value}}, награда {{reward}} алмазов', 'daily.targetFound': 'Цель найдена! ✓ • +{{points}} очков', 'daily.bonusFound': 'Бонусная цель! 💎 +{{reward}} • +{{points}} очков', 'daily.nextPuzzle': 'СЛЕДУЮЩАЯ ГОЛОВОЛОМКА', 'daily.treasureTitle': 'СОКРОВИЩЕ ГОТОВО!', 'daily.treasureSubtitle': 'Заход завершён. Пакет сокровищ готов.', 'daily.reward': 'Пакет сокровищ: {{gems}} алмазов', 'daily.claimReward': 'ПОЛУЧИТЬ НАГРАДУ', 'daily.completedTitle': 'ЕЖЕДНЕВНОЕ ИСПЫТАНИЕ ЗАВЕРШЕНО', 'daily.completedHaul': '+{{points}} очков · 💎 +{{gems}}', 'daily.completedSummary': 'Вы решили восемь головоломок. Играйте снова: новые задания, те же награды.', 'daily.alreadyCompleted': 'Сегодняшнее испытание пройдено, серия зачтена. Играйте сколько угодно: каждый заход даёт новые задания и снова приносит очки, бонусные алмазы и пакет сокровищ.', 'daily.replayRewards': 'Играйте снова: каждый заход — новые задания и полная награда.', 'daily.returnHome': 'НА ГЛАВНУЮ', 'daily.hudTitle': 'ЕЖЕДНЕВНОЕ ИСПЫТАНИЕ', 'daily.puzzleHud': 'Головоломка {{current}}/{{total}}', 'daily.tierWarmup': 'Разминка', 'daily.tierTempo': 'Темп', 'daily.tierPeak': 'Вершина', 'daily.stepsLabel': '{{steps}} шага', 'daily.transitionComplete': 'ГОЛОВОЛОМКА РЕШЕНА', 'daily.transitionNext': 'СЛЕДУЮЩАЯ ОСТАНОВКА', 'daily.transitionTreasure': 'К СОКРОВИЩУ', 'daily.transitionPeak': 'МИНИ-ИСПЫТАНИЕ', 'daily.briefingGoals': 'ЦЕЛИ ДНЯ', 'daily.railA11y': 'Дорожка головоломок {{completed}}/{{total}}', 'daily.miniChallenge': 'Мини-испытание',
    ...
    'home.pointsA11y': '{{value}} очков', 'home.gemsA11y': '{{value}} алмазов', 'home.playA11y': 'Уровень {{level}}, продолжить', 'home.playHint': 'Открывает текущую головоломку', 'home.worldRoute': 'Мировой маршрут', 'home.routeProgress': '{{route}}, пройдено стран: {{progress}}/{{total}}', 'home.countryDone': 'пройдено', 'home.currentCountry': 'текущая страна', 'home.notUnlocked': 'ещё не открыто', 'home.discovered': '🌍 Открыто стран: {{done}}/{{total}}', 'home.learningLevel': 'Мастерство {{level}}', 'home.dailyCardLabel': 'Ежедневное испытание · 🔥', 'home.dailyCardA11y': 'Ежедневное испытание', 'home.dailyReady': 'Сегодняшнее испытание готово', 'home.dailyDone': 'Пройдено · играть снова', 'home.dailyClaim': 'Забрать награду',
    'profile.title': 'ПРОФИЛЬ', 'profile.explorer': 'Исследователь мира', 'profile.location': 'Уровень {{level}} • {{country}} • {{city}}', 'profile.difficultyEyebrow': 'СЛОЖНОСТЬ ИГРЫ', 'profile.learningLevel': 'Мастерство {{level}}', 'profile.difficultyAdvanced': 'ВЫСОКИЙ', 'profile.difficultySupported': 'С ПОДДЕРЖКОЙ', 'profile.difficultyBalanced': 'СБАЛАНСИРОВАННЫЙ', 'profile.difficultyPending': 'Решите ещё несколько головоломок, чтобы определить подходящую сложность.', 'profile.difficultyHarder': 'С учётом последних результатов набор чисел в следующих городах станет немного шире.', 'profile.difficultyEasier': 'С учётом последних результатов набор чисел в следующих городах станет немного доступнее.', 'profile.difficultySame': 'Текущая сложность сохраняется с учётом последних результатов.', 'profile.difficultyMeta': 'Оценено последних головоломок: {{count}} • Сложность меняется в новом городе и снижается после повторных трудностей', 'profile.completedPuzzles': 'РЕШЕНО ГОЛОВОЛОМОК', 'profile.country': 'СТРАНЫ', 'profile.gem': 'АЛМАЗЫ', 'profile.currentJourney': 'ТЕКУЩЕЕ ПУТЕШЕСТВИЕ', 'profile.worldTour': 'Тур по миру: {{done}}/{{total}}', 'profile.playerLevel': 'Уровень игрока: {{level}}', 'profile.bonuses': '⭐ Найдено бонусных комбинаций: {{count}}', 'profile.passport': 'Паспорт путешественника', 'profile.passportStamps': 'Штампы стран: {{done}}/{{total}}', 'profile.openPassport': 'Открыть паспорт путешественника', 'profile.resume': '▶  ПРОДОЛЖИТЬ УРОВЕНЬ', 'profile.resumeA11y': 'Продолжить текущий уровень',
    ...
    'tutorial.eyebrow': 'ОБУЧЕНИЕ · {{current}}/{{total}}', 'tutorial.bonusTitle': '💎 НАЙДИТЕ БОНУСНУЮ ЦЕЛЬ', 'tutorial.targetTitle': 'НАЙДИТЕ ЦЕЛЬ', 'tutorial.explanation': '{{operation}} • шагов: {{steps}}', 'tutorial.shuffleInstruction': 'Сначала перемешайте числа.', 'tutorial.hintInstruction': 'Нажмите подсказку, чтобы увидеть решение.', 'tutorial.demoInstruction': 'Подсказка: соединяйте числа по порядку.', 'tutorial.practiceInstruction': 'Теперь решите ту же задачу сами.', 'tutorial.connectInstruction': 'Соедините правильные числа по порядку.', 'tutorial.practiceButton': 'РЕШИТЕ САМИ', 'tutorial.shuffleButton': '↻ ПЕРЕМЕШАТЬ', 'tutorial.hintButton': '💡 ПОДСКАЗКА', 'tutorial.expression': '{{expression}} = {{target}}', 'tutorial.skip': 'ПРОПУСТИТЬ', 'tutorial.skipA11y': 'Пропустить обучение', 'tutorial.celebrateTitle': 'Ты готов!', 'tutorial.celebrateSubtitle': 'Вы прошли все пять уроков.', 'tutorial.celebrateDone': 'Обучение завершено', 'tutorial.celebrateBody': 'Пора открывать чудеса!',
    'wheel.a11y': 'Круг соединения чисел', 'wheel.hint': '💎 {{cost}}', 'wheel.hintA11y': 'Показать подсказку, стоимость {{cost}} алмазов', 'wheel.hintAd': '+{{reward}}', 'wheel.hintAdA11y': 'Смотрите рекламу, получите {{reward}} алмазов', 'wheel.hintAdCta': 'Смотрите рекламу, получите {{reward}} алмазов', 'wheel.noHints': 'Недостаточно алмазов', 'wheel.shuffle': 'Перемешать', 'wheel.shuffleA11y': 'Перемешать числа',
    'modal.passportTitle': 'Коллекция паспортов', 'modal.passportFooter': 'Новый паспорт выдаётся за 3 пункта назначения и испытание страны. Коллекция: {{done}}/{{total}}.', 'modal.firstPassport': 'Завершите все уровни страны, и здесь появится ваш первый паспорт.', 'modal.passportWon': 'ПАСПОРТ ПОЛУЧЕН ✓', 'modal.startGame': 'Начать игру', 'modal.start': 'НАЧАТЬ', 'modal.finalGame': 'ФИНАЛЬНАЯ ИГРА', 'modal.countryChallenge': 'ИСПЫТАНИЕ СТРАНЫ', 'modal.worldFinal': 'ФИНАЛЬНОЕ ИСПЫТАНИЕ МИРОВОГО ТУРА', 'modal.masterTour': 'Перейти в мастер-тур по миру', 'modal.goToCountry': 'Перейти в страну {{country}}', 'modal.masterTourButton': 'НАЧАТЬ МАСТЕР-ТУР', 'modal.countryButton': '{{flag}} ПЕРЕЙТИ: {{country}}', 'modal.worldDiscovered': 'Открыто стран: {{count}} / {{count}}', 'modal.countryReward': 'Головоломки: {{count}} / {{count}} • Получен штамп', 'modal.countryComplete': '{{country}} — пройдено!', 'modal.newRouteStamp': 'Новый штамп маршрута', 'modal.passportStamp': 'Штамп в паспорт', 'modal.newLeg': 'ОТКРЫТ НОВЫЙ ЭТАП МАРШРУТА', 'modal.firstStop': 'Первая остановка: {{destination}}', 'modal.specialRewards': 'ОСОБЫЕ НАГРАДЫ', 'modal.worldLit': 'Вся карта мира теперь освещена.', 'modal.viewMap': 'СМОТРЕТЬ КАРТУ', 'modal.viewMapA11y': 'Открыть карту путешествия',
    'feedback.tryAnother': 'Попробуйте другой порядок', 'feedback.invalid': 'Этот порядок не образует допустимую операцию', 'feedback.alreadyFound': 'Вы уже нашли эту комбинацию', 'feedback.noHints': 'Недостаточно алмазов • Подсказка стоит {{cost}} алмазов', 'feedback.hintAdPreparing': 'Реклама загружается…', 'feedback.hintUnavailable': 'Не удалось подготовить подсказку для этой цели', 'feedback.followGlow': 'Соедините светящиеся числа по порядку',
    ...
    'feedback.masterStarted': '🌍 Начался мастер-тур по миру!', 'feedback.countryUnlocked': '{{flag}} {{country}} открыта • {{destination}}{{reward}}', 'feedback.routeGemReward': ' • Награда за маршрут: +{{count}} алмазов', 'feedback.routeGemToast': '💎 Новый штамп маршрута • +{{count}} алмазов',
  },
} as const;
