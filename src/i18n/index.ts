...
const translations = {
  tr: {
    ...
    'daily.title': 'GÜNLÜK KEŞİF',
    'daily.subtitle': 'Bugünün sayı yolculuğunu tamamla ve ödüllerini topla.',
    'daily.loading': 'Günlük keşif hazırlanıyor…',
    'daily.backA11y': 'Günlük keşiften geri dön',
    'daily.puzzleProgress': '{{completed}}/{{total}} bulmaca tamamlandı',
    'daily.goalSolvePuzzles': 'Tüm günlük bulmacaları çöz',
    'daily.goalBonus': 'Tüm bonus hedefleri bul',
    'daily.goalNoHints': 'İpucu kullanmadan tamamla',
    'daily.streak': '🔥 {{count}} günlük seri',
    'daily.start': 'KEŞFE BAŞLA',
    'daily.targetA11y': 'Hedef {{value}}, {{steps}} sayı',
    'daily.bonusA11y': 'Bonus hedef {{value}}, {{steps}} sayı',
    'daily.targetFound': 'Hedef bulundu! ✓',
    'daily.bonusFound': 'Bonus hedef bulundu! 💎',
    'daily.nextPuzzle': 'SONRAKİ BULMACA',
    'daily.treasureTitle': 'GÜNLÜK ÖDÜLÜN HAZIR!',
    'daily.treasureSubtitle': 'Bugünün keşfini tamamladın.',
    'daily.reward': 'Toplam {{gems}} mücevher kazandın',
    'daily.claimReward': 'ÖDÜLÜ AL',
    'daily.completedTitle': 'GÜNLÜK KEŞİF TAMAMLANDI',
    'daily.completedSummary': 'Bugünün {{total}} bulmacasını çözdün. Yarın yeni bir keşif seni bekliyor.',
    'daily.alreadyCompleted': 'Bugünkü ödülünü aldın. Yarın tekrar görüşürüz!',
    ...
    'home.dailyCardA11y': 'Günlük keşif, {{streak}} günlük seri',
    'home.dailyReady': 'Bugünün keşfi hazır',
    'home.dailyDone': 'Bugün tamamlandı',
  ...
  en: {
    ...
    'daily.title': 'DAILY DISCOVERY', 'daily.subtitle': 'Complete today’s number journey and collect your rewards.', 'daily.loading': 'Preparing today’s discovery…', 'daily.backA11y': 'Leave daily discovery', 'daily.puzzleProgress': '{{completed}}/{{total}} puzzles completed', 'daily.goalSolvePuzzles': 'Solve all daily puzzles', 'daily.goalBonus': 'Find all bonus targets', 'daily.goalNoHints': 'Complete without hints', 'daily.streak': '🔥 {{count}} day streak', 'daily.start': 'START DISCOVERING', 'daily.targetA11y': 'Target {{value}}, {{steps}} numbers', 'daily.bonusA11y': 'Bonus target {{value}}, {{steps}} numbers', 'daily.targetFound': 'Target found! ✓', 'daily.bonusFound': 'Bonus target found! 💎', 'daily.nextPuzzle': 'NEXT PUZZLE', 'daily.treasureTitle': 'YOUR DAILY REWARD IS READY!', 'daily.treasureSubtitle': 'You completed today’s discovery.', 'daily.reward': 'You earned {{gems}} gems in total', 'daily.claimReward': 'CLAIM REWARD', 'daily.completedTitle': 'DAILY DISCOVERY COMPLETED', 'daily.completedSummary': 'You solved today’s {{total}} puzzles. A new discovery will be ready tomorrow.', 'daily.alreadyCompleted': 'You claimed today’s reward. See you tomorrow!', 'daily.returnHome': 'RETURN HOME',
    ...
    'home.pointsA11y': '{{value}} points', 'home.gemsA11y': '{{value}} gems', 'home.playA11y': 'Level {{level}}, continue', 'home.playHint': 'Opens your current number puzzle', 'home.worldRoute': 'World route', 'home.routeProgress': '{{route}}, {{progress}}/{{total}} countries completed', 'home.countryDone': 'completed', 'home.currentCountry': 'current country', 'home.notUnlocked': 'not unlocked yet', 'home.discovered': '🌍 {{done}}/{{total}} countries discovered', 'home.dailyCardA11y': 'Daily discovery, {{streak}} day streak', 'home.dailyReady': 'Today’s discovery is ready', 'home.dailyDone': 'Completed today', 'home.dailyClaim': 'Claim your reward',
  ...
  ru: {
    ...
    'daily.title': 'ЕЖЕДНЕВНОЕ ОТКРЫТИЕ', 'daily.subtitle': 'Пройдите сегодняшнее путешествие чисел и получите награды.', 'daily.loading': 'Готовим ежедневное открытие…', 'daily.backA11y': 'Выйти из ежедневного открытия', 'daily.puzzleProgress': 'Пройдено головоломок: {{completed}}/{{total}}', 'daily.goalSolvePuzzles': 'Решите все ежедневные головоломки', 'daily.goalBonus': 'Найдите все бонусные цели', 'daily.goalNoHints': 'Пройдите без подсказок', 'daily.streak': '🔥 Серия: {{count}} дн.', 'daily.start': 'НАЧАТЬ ОТКРЫТИЕ', 'daily.targetA11y': 'Цель {{value}}, чисел: {{steps}}', 'daily.bonusA11y': 'Бонусная цель {{value}}, чисел: {{steps}}', 'daily.targetFound': 'Цель найдена! ✓', 'daily.bonusFound': 'Бонусная цель найдена! 💎', 'daily.nextPuzzle': 'СЛЕДУЮЩАЯ ГОЛОВОЛОМКА', 'daily.treasureTitle': 'ЕЖЕДНЕВНАЯ НАГРАДА ГОТОВА!', 'daily.treasureSubtitle': 'Вы завершили сегодняшнее открытие.', 'daily.reward': 'Всего получено алмазов: {{gems}}', 'daily.claimReward': 'ПОЛУЧИТЬ НАГРАДУ', 'daily.completedTitle': 'ЕЖЕДНЕВНОЕ ОТКРЫТИЕ ЗАВЕРШЕНО', 'daily.completedSummary': 'Вы решили сегодняшние {{total}} головоломок. Завтра будет новое открытие.', 'daily.alreadyCompleted': 'Сегодняшняя награда уже получена. До завтра!', 'daily.returnHome': 'НА ГЛАВНУЮ',
