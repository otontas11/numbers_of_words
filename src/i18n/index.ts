...
const translations = {
  tr: {
    ...
    'daily.subtitle': 'Sekiz bulmacayı çöz: her işlemden iki. İlk tamamlamada seri ve mücevher ödülü bir kez verilir.',
    ...
    'daily.replayA11y': 'Bugünün meydan okumasını antrenman olarak tekrar oyna',
    'daily.trainingBadge': 'Ödül alındı · antrenman',
    'daily.targetA11y': 'Hedef {{value}}, {{steps}} sayı',
    'daily.bonusA11y': 'Bonus hedef {{value}}, {{steps}} sayı, ödül {{reward}} mücevher',
    ...
    'daily.treasureSubtitle': 'Bugünün meydan okumasını tamamladın.',
    'daily.reward': 'Toplam {{gems}} mücevher kazandın',
    'daily.claimReward': 'ÖDÜLÜ AL',
    'daily.completedTitle': 'GÜNLÜK MEYDAN OKUMA TAMAMLANDI',
    'daily.completedSummary': 'Bugünün {{total}} bulmacasını çözdün. Antrenman için aynı seti tekrar oynayabilirsin.',
    'daily.alreadyCompleted': 'İlk ödülün alındı. Serin duruyor; tekrar oynamak ödül vermez.',
  ...
  en: {
    ...
    'daily.title': 'DAILY CHALLENGE', 'daily.subtitle': 'Solve eight puzzles, two of each operation. Streak and gems are awarded once on the first finish.', 'daily.loading': 'Preparing today’s challenge…', 'daily.backA11y': 'Leave daily challenge', 'daily.puzzleProgress': '{{completed}}/{{total}} puzzles completed', 'daily.goalSolvePuzzles': 'Solve all puzzles', 'daily.goalBonus': 'Find all bonus targets', 'daily.goalBonusExtra': 'Extra pack +{{gems}} gems', 'daily.goalNoHints': 'Finish without hints', 'daily.streak': '🔥 {{count}} day streak', 'daily.hudStreak': '🔥 {{count}}', 'daily.start': 'START THE CHALLENGE', 'daily.continueRun': 'CONTINUE', 'daily.replay': 'PLAY AGAIN', 'daily.replayA11y': 'Replay today’s challenge as training', 'daily.trainingBadge': 'Reward claimed · training', 'daily.targetA11y': 'Target {{value}}, {{steps}} numbers', 'daily.bonusA11y': 'Bonus target {{value}}, {{steps}} numbers, reward {{reward}} gems', 'daily.targetFound': 'Target found! ✓ • +{{points}} points', 'daily.bonusFound': 'Bonus target! 💎 +{{reward}} • +{{points}} points', 'daily.nextPuzzle': 'NEXT PUZZLE', 'daily.treasureTitle': 'TREASURE READY!', 'daily.treasureSubtitle': 'You completed today’s challenge.', 'daily.reward': 'You earned {{gems}} gems in total', 'daily.claimReward': 'CLAIM REWARD', 'daily.completedTitle': 'DAILY CHALLENGE COMPLETED', 'daily.completedSummary': 'You solved today’s {{total}} puzzles. You can replay the same set for training.', 'daily.alreadyCompleted': 'Today’s reward is claimed. Your streak stands; replay grants no gems.', 'daily.returnHome': 'RETURN HOME', 'daily.hudTitle': 'DAILY CHALLENGE', 'daily.puzzleHud': 'Puzzle {{current}}/{{total}}', 'daily.tierWarmup': 'Warm-up', 'daily.tierTempo': 'Tempo', 'daily.tierPeak': 'Peak', 'daily.stepsLabel': '{{steps}} steps', 'daily.transitionComplete': 'PUZZLE COMPLETE', 'daily.transitionNext': 'NEXT STOP', 'daily.transitionTreasure': 'TREASURE AHEAD', 'daily.transitionPeak': 'MINI CHALLENGE', 'daily.briefingGoals': 'TODAY’S GOALS', 'daily.railA11y': '{{completed}}/{{total}} puzzle track', 'daily.miniChallenge': 'Mini challenge',
  ...
  ru: {
    ...
    'daily.title': 'ЕЖЕДНЕВНОЕ ИСПЫТАНИЕ', 'daily.subtitle': 'Решите восемь головоломок — по две на каждую операцию. Серия и алмазы даются один раз за первое прохождение.', 'daily.loading': 'Готовим ежедневное испытание…', 'daily.backA11y': 'Выйти из ежедневного испытания', 'daily.puzzleProgress': 'Пройдено головоломок: {{completed}}/{{total}}', 'daily.goalSolvePuzzles': 'Решите все головоломки', 'daily.goalBonus': 'Найдите все бонусные цели', 'daily.goalBonusExtra': 'Доп. пакет +{{gems}} алмазов', 'daily.goalNoHints': 'Пройдите без подсказок', 'daily.streak': '🔥 Серия: {{count}} дн.', 'daily.hudStreak': '🔥 {{count}}', 'daily.start': 'НАЧАТЬ ИСПЫТАНИЕ', 'daily.continueRun': 'ПРОДОЛЖИТЬ', 'daily.replay': 'ИГРАТЬ СНОВА', 'daily.replayA11y': 'Повторить сегодняшнее испытание как тренировку', 'daily.trainingBadge': 'Награда получена · тренировка', 'daily.targetA11y': 'Цель {{value}}, чисел: {{steps}}', 'daily.bonusA11y': 'Бонусная цель {{value}}, чисел: {{steps}}, награда {{reward}} алмазов', 'daily.targetFound': 'Цель найдена! ✓ • +{{points}} очков', 'daily.bonusFound': 'Бонусная цель! 💎 +{{reward}} • +{{points}} очков', 'daily.nextPuzzle': 'СЛЕДУЮЩАЯ ГОЛОВОЛОМКА', 'daily.treasureTitle': 'СОКРОВИЩЕ ГОТОВО!', 'daily.treasureSubtitle': 'Вы завершили сегодняшнее испытание.', 'daily.reward': 'Всего получено алмазов: {{gems}}', 'daily.claimReward': 'ПОЛУЧИТЬ НАГРАДУ', 'daily.completedTitle': 'ЕЖЕДНЕВНОЕ ИСПЫТАНИЕ ЗАВЕРШЕНО', 'daily.completedSummary': 'Вы решили сегодняшние {{total}} головоломок. Тот же набор можно пройти снова как тренировку.', 'daily.alreadyCompleted': 'Первая награда уже получена. Серия сохраняется; повтор не даёт алмазов.', 'daily.returnHome': 'НА ГЛАВНУЮ', 'daily.hudTitle': 'ЕЖЕДНЕВНОЕ ИСПЫТАНИЕ', 'daily.puzzleHud': 'Головоломка {{current}}/{{total}}', 'daily.tierWarmup': 'Разминка', 'daily.tierTempo': 'Темп', 'daily.tierPeak': 'Вершина', 'daily.stepsLabel': '{{steps}} шага', 'daily.transitionComplete': 'ГОЛОВОЛОМКА РЕШЕНА', 'daily.transitionNext': 'СЛЕДУЮЩАЯ ОСТАНОВКА', 'daily.transitionTreasure': 'К СОКРОВИЩУ', 'daily.transitionPeak': 'МИНИ-ИСПЫТАНИЕ', 'daily.briefingGoals': 'ЦЕЛИ ДНЯ', 'daily.railA11y': 'Дорожка головоломок {{completed}}/{{total}}', 'daily.miniChallenge': 'Мини-испытание',
