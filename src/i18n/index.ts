...
const translations = {
  tr: {
    ...
    'wheel.hint': '💎 {{cost}}',
    'wheel.hintA11y': 'İpucu göster, ücret {{cost}} kristal',
    'wheel.noHints': 'Yetersiz kristal',
    ...
    'feedback.noHints': 'Yetersiz kristal • İpucu için {{cost}} kristal gerekli',
    ...
    'feedback.masterStarted': '🌍 Master World Tour başladı!', 'feedback.countryUnlocked': '{{flag}} {{country}} açıldı • {{destination}}{{reward}}', 'feedback.routeGemReward': ' • Yeni rota ödülü: +{{count}} kristal',
  },
  en: {
    ...
    'wheel.a11y': 'Number connection wheel', 'wheel.hint': '💎 {{cost}}', 'wheel.hintA11y': 'Show hint, costs {{cost}} crystals', 'wheel.noHints': 'Not enough crystals', 'wheel.shuffle': 'Shuffle', 'wheel.shuffleA11y': 'Shuffle numbers',
    ...
    'feedback.tryAnother': 'Try another order', 'feedback.invalid': 'This order does not form a valid operation', 'feedback.alreadyFound': 'You already discovered this combination', 'feedback.noHints': 'Not enough crystals • A hint costs {{cost}} crystals', 'feedback.hintUnavailable': 'No hint could be prepared for this target', 'feedback.followGlow': 'Connect the glowing numbers in order',
    ...
    'feedback.masterStarted': '🌍 Master World Tour started!', 'feedback.countryUnlocked': '{{flag}} {{country}} unlocked • {{destination}}{{reward}}', 'feedback.routeGemReward': ' • New route reward: +{{count}} crystals',
  },
  ru: {
    'language.tr': 'Türkçe', 'language.en': 'English', 'language.ru': 'Русский',
    ...
    'wheel.a11y': 'Круг соединения чисел', 'wheel.hint': '💎 {{cost}}', 'wheel.hintA11y': 'Показать подсказку, стоимость {{cost}} кристаллов', 'wheel.noHints': 'Недостаточно кристаллов', 'wheel.shuffle': 'Перемешать', 'wheel.shuffleA11y': 'Перемешать числа',
    ...
    'feedback.masterStarted': '🌍 Начался мастер-тур по миру!', 'feedback.countryUnlocked': '{{flag}} {{country}} открыта • {{destination}}{{reward}}', 'feedback.routeGemReward': ' • Награда за маршрут: +{{count}} кристаллов',
  },
} as const;
