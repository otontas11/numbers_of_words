...
const translations = {
  ...
  en: {
    ...
    'home.pointsA11y': '{{value}} points', 'home.gemsA11y': '{{value}} gems', 'home.playA11y': 'Level {{level}}, continue', 'home.playHint': 'Opens your current number puzzle', 'home.worldRoute': 'World route', 'home.routeProgress': '{{route}}, {{progress}}/{{total}} countries completed', 'home.countryDone': 'completed', 'home.currentCountry': 'current country', 'home.notUnlocked': 'not unlocked yet', 'home.discovered': '🌍 {{done}}/{{total}} countries discovered', 'home.dailyCardLabel': 'Daily Challenge · 🔥', 'home.dailyCardA11y': 'Daily challenge', 'home.dailyReady': 'Today’s challenge is ready', 'home.dailyDone': 'Completed · play again', 'home.dailyClaim': 'Claim your reward',
    ...
    'wheel.a11y': 'Number connection wheel', 'wheel.hint': '💎 {{cost}}', 'wheel.hintA11y': 'Show hint, costs {{cost}} gems', 'wheel.noHints': 'Not enough gems', 'wheel.shuffle': 'Shuffle', 'wheel.shuffleA11y': 'Shuffle numbers',
  ...
  ru: {
    ...
    'wheel.a11y': 'Круг соединения чисел', 'wheel.hint': '💎 {{cost}}', 'wheel.hintA11y': 'Показать подсказку, стоимость {{cost}} алмазов', 'wheel.noHints': 'Недостаточно алмазов', 'wheel.shuffle': 'Перемешать', 'wheel.shuffleA11y': 'Перемешать числа',
