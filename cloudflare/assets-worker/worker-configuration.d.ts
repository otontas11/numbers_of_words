/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/assets-worker/wrangler.jsonc cloudflare/assets-worker/worker-configuration.d.ts` (hash: ebbe4016149875d3bf7884f67316fd2a)
