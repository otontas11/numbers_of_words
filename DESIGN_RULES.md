...
8. Country Challenge tamamlanınca vize pulu ve landmark kazanılır. Ülke modalında birincil eylem sonraki ülkeye/puzzle’a devamdır; ikinci eylem `Haritayı gör` ile Seyahat ekranını açar. Günlük keşif ve kayıtlı ana tur tahtası bu kısayolla ezilmez. Geri tuşu varsayılanı ana menüdür.
...
- Ekranın merkezindeki büyük altın çerçeveli `BÖLÜM` düğmesi aktif ülke/destinasyon içindeki puzzle numarasını gösterir ve kayıtlı sayı matrisi ile çözülmüş hedeflerden **tek dokunuşla** devam eder. Ana menüde Günlük Keşif kartı streak ve bugünkü ödül/durumu gösterir; alt `GÖREVLER` aynı ekranı açar. Daily kendi progress storage’sunu kullanır; ödül mücevheri ana bakiyeye eklenir, ana tur tahtasını ezmez.
