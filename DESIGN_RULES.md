...
- Country Challenge açıldığında ödül veya ek açıklama içermeyen, yalnız `COUNTRY CHALLENGE` bilgisini belirginleştiren kısa bir başlangıç modalı gösterilir. Toplama Challenge hedefleri ülkelere göre dönüşümlü olarak 3 veya 4 adımlıdır; çıkarma, çarpma ve bölme mevcut adım mantığını korur.
